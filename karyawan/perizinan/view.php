                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <a href="tambahizin.php" class="btn btn-primary">Buat Perizinan</a>
                                </h6>
                            </div>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['awal_izin']; ?></td>
                                                <td><?php echo $data['selesai_izin']; ?></td>
                                                <td style="width: 250px;"><?php echo $data['keterangan_izin']; ?></td>
