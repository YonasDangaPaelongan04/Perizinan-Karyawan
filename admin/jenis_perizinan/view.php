                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="alert alert-success" role="alert">
                            Jenis Perizinan Berhasil Ditambah
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <a href="tambah.php" class="btn btn-primary">Tambah Data Izin</a>
                                </h6>
                            </div>
                            <div class="card-body">
                                <div>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Jenis Izin</th>
                                                <th style="width:500px">Keterangan Izin</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="ubah.php?id=<?php echo $data['id_izin_list']; ?>"
                                                        type="button" class="btn btn-warning">Edit</a>
                                                    <a href="hapus.php?id_izin_list=<?php echo $data['id_izin_list']; ?>"
