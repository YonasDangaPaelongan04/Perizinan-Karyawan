            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800">Tambah Jenis Izin</h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <form action="fungsi.php" method="POST">
                                ...
                                <div class="ml-5 mb-3 mr-5 mt-5">
                                    ...
                                    <input type="text" class="form-control" name="nama_izin" id="nama_izin">
                                </div>

                                <div class="ml-5 mb-3 mr-5 mt-2">
                                    <label for="exampleInputEmail1" class="form-label">Keterangan Izin</label>
                                    <input type="text" class="form-control" name="keterangan_izin" id="keterangan_izin">
                                </div>
